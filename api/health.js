...
export default function handler(req, res) {
  ...
  res.end(JSON.stringify({
    ...
    assetVersion: "20260905d",
    features: { documentDelete: true, groupware: true, notices: true, onboarding: true, tasks: true, members: true, messages: true, assets: true, templates: true, settings: true, advisor: true },
    env,
