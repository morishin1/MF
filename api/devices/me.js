...
export const AGENT_NOTICE = {
  ...
  why: "会社のパソコンから、お客様の情報が外に出ていないかを確かめること、"
     + "在宅勤務のときの働き方を見ることが目的です。"
     + "働きぶりを点数にしたり、評価に直接使ったりはしません。",
  // 「URLを取る」と書いたうえで、どこまで削っているかを同じ場所に書く。
  // 削っていることだけ書いて、取っていることを書かない案内にはしない
  how: "アドレスのうち、? から後ろ（検索したことば・メールアドレス・"
     + "ログインの鍵が入るところ）と # から後ろは、このパソコンの中で捨ててから送ります。"
     + "一度きりのリンクに見える部分も伏せます。",
  yours: "自分が見られている記録は、いつでもマイページから確認できます。"
       + "管理者があなたのWEB利用を開いたときは、それもあなたの画面に残ります。",
  // 勤務時間の内と外で、扱いを分けていることを本人にも伝える
  scope: "働き方を見るために使うのは、原則として勤務時間内のぶんだけです。"
