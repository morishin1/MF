...
-- =============================================================================
-- 039_consent_and_drive.sql — 電子同意（版付き）／提出書類の Drive 自動整理
-- =============================================================================
-- 1) 同意してもらう書類（版付き）
...
-- =============================================================================
-- 040_reminders.sql — 1日3回の声かけ（デスクトップ通知）
-- =============================================================================
...
-- =============================================================================
-- 042_week_plan.sql — 週のゴールと、その日の行動案
-- =============================================================================
...
-- =============================================================================
-- 043_drive_links.sql — メンバーに渡すフォルダのリンク
-- =============================================================================
...
-- =============================================================================
-- 048_timecard.sql — タイムカード（打刻・修正申請・月締め）
--
-- ■ 何を残すものか
...
-- =============================================================================
-- 049_action_triage.sql — AI提案の選別と、期日から逆算した並べ替え
-- =============================================================================
...
-- =============================================================================
-- 054_device_agent.sql
-- =============================================================================
-- 054: 端末管理（常駐エージェント）。053 の続き
--
-- ■ 台帳は1つ。載り方が2つある
--   source='browser' … ブラウザの localStorage が持つID
--   source='agent'   … PCに入れた常駐ソフト
--   同じPCで両方が載る。linked_device_id でつなぐ
--
-- ■ 社員のアカウントをPCに置かない
--   端末専用の資格情報（secret_hash）。平文は保存しない
--
-- ■ 本人が承認するまで収集しない
--   notified_at が null のあいだ、サーバは collect:false を返す
-- =============================================================================
