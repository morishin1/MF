...
export function nextActionOf(a, nextInterview = null, currentOffer = null) {
  ...
  const AWAITING_RESPONSE = ["offer_send_pending", "offer_resend_pending", "offer_sent", "offer_viewed"];
