 ...
 *
 * @param {{date:string, workSec:number, distractSec:number, nightSec:number,
 *          label?:string, policy?:object}} p
 */
export function webAlerts({ date, distractSec = 0, nightSec = 0, label = "", policy = {} }) {
  const out = [];
