...
// 画面に出す10項目。ラベルはメンバー画面・管理画面で共通に使う
export const SECTIONS = [
  { key: "purpose",      no: "①", label: "今日の目的" },
  { key: "kpis",         no: "②", label: "今日のKPI" },
  { key: "today_work",   no: "③", label: "今日の成果" },
  { key: "handoff",      no: "④", label: "次工程への引き継ぎ" },
  { key: "stuck",        no: "⑤", label: "止まっていること" },
  { key: "miss_reason",  no: "⑤-2", label: "未達の原因" },
  { key: "challenge",    no: "⑥", label: "今日の挑戦・改善" },
  { key: "small_win",    no: "⑦", label: "今日の小さな成功" },
  { key: "thanks",       no: "⑧", label: "今日の感謝" },
  { key: "contribution", no: "⑨", label: "顧客・会社への貢献" },
  { key: "tomorrow_plan", no: "⑩", label: "明日の最優先" },
];
...
export function hasContent(n) {
  return Boolean(
    n.purpose || n.today_work || n.tomorrow_plan || n.challenge ||
    n.small_win || n.contribution || n.kpis || n.handoff
  );
}
