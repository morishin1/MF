...
export const SCREENS = [
  ...
  "info", "notices", "library", "directory", "mypage", "contracts", "timecard",
...
export const ALLOWED = {
  ...
  // 入社前に雇用契約書へ署名してもらうので、契約書は準備中から開けておく
  preparing: ["home", "tasks", "dojo", "onboarding", "contracts", "mypage", "menu", "help"],
  member: SCREENS,
  leaving: SCREENS,
